...
\] is ${3.402} \cdot {{10} ^ {38}}$. For $x=19$ and $\tau{}={2} \cdot {\pi{}}$, \begin{align*}{{2} + {{7} \cdot {\left({6} - {\tau{}}\right)}}} - {e^{{5} - {\sqrt{{{x} ^ {2}} + {\frac{4}{\pi{}}}}}}}
   &\approx{}{1.77} \cdot {{10} ^ {-2}}.\end{align*}\subsection{Simple finite sums / products}\begin{align*}\sum_{{n\in{}\left\{0,1,4,5\right\}}}{\tfrac{5}{2}} - {n}
