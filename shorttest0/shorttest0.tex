...
\]\textbf{ is not. }(Test passed.)\\A simple equations chain:\begin{align*}{10} ^ {18}
 ...
 \\ &=\frac{1}{1000000000000000000}.\end{align*}\textbf{Test failed. }Even true mathematical identities may not show to hold when using floating-point arithmetics.\end{document}